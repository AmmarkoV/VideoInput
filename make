...
ar  rcs libVideoInput.a main.o image_storage.o image_storage_png.o image_storage_jpg.o V4L2_c.o PrintV4L2.o PixelFormats.o tools.o state.o  PixelFormatConversions.o 

rm main.o image_storage.o image_storage_png.o image_storage_jpg.o V4L2_c.o PrintV4L2.o PixelFormats.o tools.o state.o  PixelFormatConversions.o 
